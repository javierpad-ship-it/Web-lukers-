...
2. **Nota y número de reseñas de Google**, sumando las diez tiendas. Es el
...
6. **Teléfono y WhatsApp** correctos, con prefijo peruano (+51). Mientras
...
- ~~Horarios~~ → **tres**:
  ...
  | Horario | Tiendas |
  |---|---|
  | 10:00 – 22:00 | las seis de Lima |
  | 9:30 – 22:30 | Trujillo |
  | 9:30 – 21:30 | Chiclayo, Tarapoto, Iquitos |
